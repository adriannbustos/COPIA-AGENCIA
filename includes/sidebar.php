...
<span class="sidebar-text">Auditoría y Alertas</span>
<i class="fas fa-chevron-down sidebar-arrow"></i>
</button>
<div class="collapse <?php echo in_array($current_page, ['alertas', 'auditoria', 'reportes']) ? 'show' : ''; ?>" id="auditoriaAlertasSection">
<a href="alertas.php" class="sidebar-subitem <?php echo $current_page == 'alertas' ? 'active' : ''; ?>">
<i class="fas fa-bell"></i>
<span>Alertas</span>
<?php if (!empty($alertas_criticas)): ?>
<span class="sidebar-badge bg-danger"><?php echo count($alertas_criticas); ?></span>
<?php endif; ?>
</a>
...
<a href="reportes.php" class="sidebar-subitem <?php echo $current_page == 'reportes' ? 'active' : ''; ?>">
...
<a href="subir_fondo_credencial.php" class="sidebar-subitem <?php echo $current_page == 'subir_fondo_credencial' ? 'active' : ''; ?>">
<i class="fas fa-signature"></i>
<span>Actualizar Firmas</span>
</a>
</div>
</div>
<?php endif; ?>
