...
<a href="gestion_sucursales.php" class="sidebar-subitem <?php echo $current_page == 'gestion_sucursales' ? 'active' : ''; ?>">
<i class="fas fa-store"></i>
<span>Sucursales</span>
</a>
<!-- ✅ NUEVO ENLACE: Gestión Documentos Sucursales -->
<a href="gestion_documentos_sucursales.php" class="sidebar-subitem <?php echo $current_page == 'gestion_documentos_sucursales' ? 'active' : ''; ?>">
<i class="fas fa-file-contract"></i>
<span>Doc. Sucursales</span>
</a>
<!-- ✅ NUEVO ENLACE: Documentación Personal -->
<a href="cargar_documentacion.php" class="sidebar-subitem <?php echo $current_page == 'cargar_documentacion' ? 'active' : ''; ?>">
<i class="fas fa-user-edit"></i>
<span>Doc. Empleados</span>
</a>
<a href="recursos_empresa.php" class="sidebar-subitem <?php echo $current_page == 'recursos_empresa' ? 'active' : ''; ?>">
<i class="fas fa-toolbox"></i>
<span>Recursos</span>
</a>
<!-- ENLACE 3: cargar_servicios_empresa.php -->
<a href="cargar_servicios_empresa.php" class="sidebar-subitem <?php echo $current_page == 'cargar_servicios_empresa' ? 'active' : ''; ?>">
<i class="fas fa-concierge-bell"></i>
<span>Servicios</span>
</a>
<!-- ✅ NUEVO ENLACE: Seguimiento de Trámites -->
<a href="seguimiento_tramites.php" class="sidebar-subitem <?php echo $current_page == 'seguimiento_tramites' ? 'active' : ''; ?>">
...
// ✅ RESTAURAR ESTADO DEL SIDEBAR AL CARGAR CUALQUIER PÁGINA
...
// ✅ CERRAR SIDEBAR MOBILE AL HACER CLIC EN ENLACES (INCLUIDO DASHBOARD)
if (sidebar) {
...
// ✅ MANTENER ESTADO CONTRAÍDO EN DESKTOP
