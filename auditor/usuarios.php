...
// Verificar autenticación y rol de auditor
if (!$auth->isLoggedIn() || !$auth->hasRole('auditor')) {
...
<body>
<?php $page_title = 'Gestión de Usuarios'; include '../includes/header_auditor.php'; ?>
<div class="dashboard">
<?php include '../includes/sidebar_auditor.php'; ?>
...
body: `action=delete&id=${usuarioIdEliminar}`
})
.then(r => r.json())
.then(data => {
if (data.success) {
