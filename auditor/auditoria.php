...
if (!$auth->hasRole('auditor')) {
$_SESSION['error'] = 'Acceso denegado. Se requieren permisos de auditor.';
...
<body>
<?php $page_title = 'Auditoría de Actividades'; include '../includes/header_auditor.php'; ?>
<div class="dashboard">
