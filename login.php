...
<div class="login-wrapper">
    ...
    <div class="login-body">
        ...
        <form method="POST" action="">
            ...
            <div class="form-floating">
                <!-- Añadido padding-right para que el ícono no tape el texto -->
                ...
                <!-- Ícono toggle para mostrar/ocultar contraseña -->
                <i class="fas fa-eye input-icon toggle-password" title="Mostrar/Ocultar contraseña"></i>
            </div>
            <div class="captcha-section">
                ...
                <div class="captcha-hint mt-2"></div>
            </div>
